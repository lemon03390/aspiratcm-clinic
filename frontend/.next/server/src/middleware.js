...
;// CONCATENATED MODULE: ./src/libs/apiClient.ts
 ...
 */ const getBackendUrl = (path = "")=>{
    const apiBaseUrl = "https://clinic.aspiratcm.com/api/v1" || 0;
    // 確保路徑以/開頭，避免重複斜線
 ...
 */ class ErrorHandler {
    static handleApiError(error, context = "") {
        ...
        if (error.response) {
            ...
            if (statusCode >= 500) {
                return {
                    message: "伺服器處理請求時出錯",
                    detail: error.response.data?.detail || "服務暫時不可用，請稍後再試",
                    statusCode,
                    isServerError: true,
    ...
    static handleValidationError(error, context = "") {
        ...
        const detailMessage = Object.keys(fieldErrors).length > 0 ? `有 ${Object.keys(fieldErrors).length} 個欄位驗證失敗` : "資料格式不符合要求";
        return {
    ...
    static formatErrorForDisplay(error) {
        ...
        if (error.fieldErrors && Object.keys(error.fieldErrors).length > 0) {
            return Object.entries(error.fieldErrors).map(([field, msg])=>`${this.formatFieldName(field)}: ${msg}`).join("\n");
        }
    ...
    static formatFieldName(fieldName) {
        ...
        return fieldNameMap[fieldName] || fieldName.split("_").map((word)=>word.charAt(0).toUpperCase() + word.slice(1)).join(" ");
    }
}
// 創建 API 客戶端
const apiClient = lib_axios.create({
...
const apiClient_api = {
    appointments: {
        ...
        getByPhone: (phone)=>apiClient.get("/appointments/by-phone", {
                params: {
                    phone_number: phone
                }
            }),
...
/* harmony default export */ const libs_apiClient = ((/* unused pure expression or super */ null && (apiClient)));
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=%2FUsers%2Fmountainfung%2FDesktop%2FAWS-Aspiratcm_local%2Ffrontend&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL3YxKD86XFwvKCg%2FOlteXFwvI1xcP10rPykoPzpcXC8oPzpbXlxcLyNcXD9dKz8pKSopKT8oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvYXBpL3YxLzpwYXRoKiJ9XQ%3D%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL3YxKD86XFwvKCg%2FOlteXFwvI1xcP10rPykoPzpcXC8oPzpbXlxcLyNcXD9dKz8pKSopKT8oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvYXBpL3YxLzpwYXRoKiJ9XX0%3D!
