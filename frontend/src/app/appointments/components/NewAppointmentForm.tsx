    ...
    try {
      ...
      const response = await axios.post(
        getBackendUrl("/appointments"),
        {
          ...
          referral_source: appointmentData.referral_source,
          referral_notes: appointmentData.referral_notes
        },
        {
          headers: {
        ...
        <div className="bg-indigo-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                value={appointmentData.referral_source}
                onChange={(e) =>
                  setAppointmentData({
                    ...appointmentData,
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                value={appointmentData.referral_notes}
                onChange={(e) =>
                  setAppointmentData({
                    ...appointmentData,
